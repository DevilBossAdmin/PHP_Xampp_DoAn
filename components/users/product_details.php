                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            ...
                            <form class="cart clearfix mb-50 d-flex" method="post">
                                <div class="quantity">
                                    <span class="qty-minus" data-target="qty" role="button"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                    <input type="number" class="qty-text" id="qty" step="1" min="1" max="12" name="quantity" value="1">
                                    <span class="qty-plus" data-target="qty" role="button"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                </div>
