<?php
    ...
    if($_isUserPaymentQrPage == true) {
        ...
        include($dir_payment.'category_side_menu.php');
        include($dir_payment.'header.php');
        include($dir_payment.'payment_qr.php');
        include($dir_payment.'footer.php');
        include($dir_payment.'script.php');
    }
    if($_isUserOrderSuccessPage == true) {
        $dir_payment = _DIR_['COMPONENTS']['USERS'];
        include($dir_payment.'head.php');
        include($dir_payment.'category_side_menu.php');
        include($dir_payment.'header.php');
        include($dir_payment.'order_success.php');
        include($dir_payment.'footer.php');
        include($dir_payment.'script.php');
    }
    /** user **/
